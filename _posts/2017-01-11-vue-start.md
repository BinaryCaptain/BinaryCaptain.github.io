...
date: 2017-01-11
categories: Vue
cover: 'https://binarycaptain.github.io/assets/img/lifecycle.png'
tags: Vue
subtitle: 'Vue'
...
![](https://binarycaptain.github.io/assets/img/lifecycle.png)
...
![](https://binarycaptain.github.io/assets/img/lifecycle-1.png)
...
![](https://binarycaptain.github.io/assets/img/lifecycle-2.png)
...
![](https://binarycaptain.github.io/assets/img/lifecycle-3.png)

如果我们在后面继续调用vm.$mount(el),可以发现代码继续向下执行了

>vm.$mount(el) //这个el参数就是挂在的dom节点

![](https://binarycaptain.github.io/assets/img/lifecycle-4.png)
...
![](https://binarycaptain.github.io/assets/img/lifecycle-5.png)

那么将vue对象中template的选项注释掉后打印如下信息：

![](https://binarycaptain.github.io/assets/img/lifecycle-6.png)
...
![](https://binarycaptain.github.io/assets/img/lifecycle-7.png)
...
![](https://binarycaptain.github.io/assets/img/lifecycle-8.png)
...
![](https://binarycaptain.github.io/assets/img/lifecycle-9.png)

在mounted之前h1中还是通过 {{message}} 进行占位的，因为此时还有挂在到页面上，还是JavaScript中的虚拟DOM形式存在的。在mounted之后可以看到h1中的内容发生了变化。

5.beforeUpdate钩子函数和updated钩子函数间的生命周期

![](https://binarycaptain.github.io/assets/img/lifecycle-10.png)
...
![](https://binarycaptain.github.io/assets/img/lifecycle-11.png)

6.beforeDestroy和destroyed钩子函数间的生命周期

![](https://binarycaptain.github.io/assets/img/lifecycle-12.png)
